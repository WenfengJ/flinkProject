...
import com.youfan.stream.map.UserbrowserMap;
import com.youfan.stream.map.UsernetworkMap;
import com.youfan.stream.reduce.*;
...
//        reduce.print();
        reduce.addSink(new Usernetworksinkreduce()).name("userbrowserreduce");
        try {
